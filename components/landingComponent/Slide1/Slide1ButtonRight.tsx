...
export const Slide1RightButton = () => {
  return (
      ...
      <div className={`w-full h-full relative grid grid-cols-10 `} style={{}}>
        <div className="z-10 flex flex-col items-center justify-center col-span-10 gap-8 p-8">
          ...
          <div className={`w-min flex flex-row gap-4`}>
            <div
              className={`bg-yellow-600 hover:bg-yellow-500 transition-all w-max p-6 py-3 rounded-full text-white font-bold uppercase font-ubuntu opacity-0 pointer-events-none`}
            >
              Member/Parent
            </div>
            <button
